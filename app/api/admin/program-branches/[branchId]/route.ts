...
import { deleteUnusedProgramBranch } from '@/lib/server/services/programs';
...
export async function DELETE(
  ...
  try {
    ...
    const result = await deleteUnusedProgramBranch(principal, branchId);
    await auditService.record({
      action: 'program_branch.deleted',
